...
const WelcomeTourPage = lazy(() =>
  import("./pages/WelcomeTourPage").then((m) => ({
...
const BattleHistoryPage = lazy(
  () => import("./pages/battle/BattleHistoryPage"),
);
const New3v3Page = lazy(() => import("./pages/battle/New3v3Page"));
const NewTournamentPage = lazy(
  () => import("./pages/battle/NewTournamentPage"),
);
const TournamentJoinPage = lazy(
  () => import("./pages/battle/TournamentJoinPage"),
);
const TournamentDisplayView = lazy(
  () => import("./pages/battle/TournamentDisplayView"),
);
...
const AcademyLevelPage = lazy(() =>
  import("./pages/AcademyLevelPage").then((m) => ({
    default: m.AcademyLevelPage,
  })),
);
const AcademyLessonPage = lazy(() =>
  import("./pages/AcademyLessonPage").then((m) => ({
    default: m.AcademyLessonPage,
  })),
);
...
const AcceptChallengePage = lazy(() =>
  import("./pages/battle/AcceptChallengePage").then((m) => ({
  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-[#0A0A1A] flex flex-col items-center justify-center gap-4">
        ...
        <p className="text-primary font-display font-bold animate-pulse uppercase tracking-[0.2em]">
          Sincronizzazione...
        </p>
      </div>
    );
            ...
            <>
              ...
              {profile && !profile.onboarding_done ? (
                ...
                <>
                  ...
                  <Route
                    path="/battle/tournament/:id/display"
                  ...
                  <Route element={<Layout />}>
                    ...
                    />
                    <Route
                      path="/battle/tournament/:tournamentId"
                      element={<NewTournamentPage />}
                    />
                    <Route
                      path="/battle/tournament/:id/join"
                      element={<TournamentJoinPage />}
                    />
                    <Route path="/battle/new" element={<NewMatchPage />} />
                    <Route
                      path="/battle/accept/:battleId"
                      element={<AcceptChallengePage />}
                    />
                    <Route
                      path="/battle/live/:battleId"
                    ...
                    <Route
                      path="/academy/:levelId"
                      element={<AcademyLevelPage />}
                    />
                    <Route
                      path="/academy/:levelId/:lessonId"
