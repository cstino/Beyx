# BeyManager X — X Academy: Advanced Level (Lessons 13-18)

**Briefing for Antigravity — April 2026**

---

Hey Antigravity — third batch of Academy lessons, focused on the **Advanced** level. These 6 lessons cover competitive content: tier list reading, current meta, tournament formats, advanced launch techniques, deck building, and reading the opponent. After these, the user will be ready for proper tournament play.

> 💡 No new schema or component changes needed. Pure content seed — `level_id = 'advanced'`.
...
'[
  ...
  {"type":"diagram","src":"https://placeholder-tierlist.png","caption":"La gerarchia dei tier dal più forte al più debole"},
  {"type":"list","items":[
...
Con questi 6 lessons, l'utente ha ora **18 lezioni totali** disponibili (6 Beginner + 6 Intermediate + 6 Advanced). Il giocatore ora sa:

- Leggere e interpretare le Tier List
- Capire il meta corrente e la sua evoluzione
- Conoscere i formati di torneo (1v1, 3v3, Swiss, bracket, round robin)
- Eseguire tecniche di lancio avanzate (Bank Shot, Sliding Shoot)
- Costruire un deck competitivo bilanciato
- Leggere e anticipare l'avversario

**Prossimo blocco disponibile:**
- 🔜 **Pro** (lessons 19-24): Manutenzione delle parti, usura e sostituzione, micro-ottimizzazioni, mind games avanzati, preparazione al torneo, diventare un campione

Fammi sapere quando vuoi procedere con il livello finale Pro!

---

*End of Briefing — BeyManager X Academy Advanced — April 2026*
