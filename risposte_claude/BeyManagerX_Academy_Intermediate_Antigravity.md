# BeyManager X — X Academy: Intermediate Level (Lessons 7-12)

**Briefing for Antigravity — April 2026**

---

Hey Antigravity — second batch of Academy lessons, focused on the **Intermediate** level. These 6 lessons teach players how to make smart parts choices: archetypes, blade selection, ratchets, bits, combo building, and matchups. All content is in Italian and follows the same JSONB content block structure from the previous Academy briefing.

> 💡 No new schema or component changes needed. This is pure content seed — just SQL INSERT statements that go directly into `academy_lessons`. The `level_id` for all lessons here is `'intermediate'`.
...
Con questi 6 lessons completi, l'utente ha ora **12 lezioni totali** disponibili (6 Beginner + 6 Intermediate). I contenuti sono progettati per costruire una progressione naturale: dopo aver imparato cos'è un Beyblade nel Beginner, ora il giocatore sa come scegliere e combinare le parti.

**Prossimi blocchi disponibili:**
- 🔜 **Advanced** (lessons 13-18): Tier list, meta corrente, formati di torneo, tecniche di lancio avanzate, deck building, lettura dell'avversario
- 🔜 **Pro** (lessons 19-24): Manutenzione parti, micro-ottimizzazioni, mind games, preparazione torneo, diventare campione

Fammi sapere quando vuoi procedere con il livello Advanced!

---

*End of Briefing — BeyManager X Academy Intermediate — April 2026*
